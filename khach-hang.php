        ...
        <div class="container-fluid">
          ...
          <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modelId">
            ...
            if (isset($_POST['INSERT'])){
                ...
                $insert = mysqli_query($conn,"INSERT INTO customer(NAME_CUSTOMER,PHONE_CUSTOMER,EMAIL_CUSTOMER,ADDRESS_CUSTOMER) VALUE (N'$name_customer_insert',N'$phone_customer_insert',N'$email_customer_insert',N'$address_customer_insert')");
                if($insert){
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class=" row" method="post" >
                      ...
                      <input class="col-sm-8 avc" type="text" name="name_customer_insert" id="name" class="form-control" placeholder="" aria-describedby="helpId">



                      <label class="col-sm-4 avc" for="phone" style="font-weight: bold">Số Điện Thoại</label>
                      <input class="col-sm-8 avc" type="text" name="phone_customer_insert" id="phone" class="form-control" placeholder="" aria-describedby="helpId">



                      <label class="col-sm-4 avc" for="email" style="font-weight:bold ">Email</label>
                      <input class="col-sm-8 avc" type="email" name="email_customer_insert" id="email" class="form-control" placeholder="" aria-describedby="helpId">



                      <label class="col-sm-4 avc" for="address" style="font-weight: bold">Địa Chỉ</label>
                      <input class="col-sm-8 avc" type="text" name="addresss_customer_insert" id="address" class="form-control" placeholder="" aria-describedby="helpId">


                  </form>
                </div>
                <div class="modal-footer">
                    <input type="submit" name="INSERT" value="SAVE" style="background-color: #dfff2e">
                </div>
              </div>
            </div>
          </div>
